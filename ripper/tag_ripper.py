...
class TagRipper(MapLoader):
    ...
    def rip_tags(self):
        ...
        if not self.hashcaches_loaded:
            self.hash_cacher.load_all_hashmaps()
            self.hashcaches_loaded = True
    ...
    def get_meta_path(self, hashmap, meta_header, def_id, seen, rebuild_paths,
                      mapdata, tag_ref_paths, reflexive_paths, rawdata_paths):
